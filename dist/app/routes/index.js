...
const academicFaculty_route_2 = require("../modules/academicDepartment/academicFaculty.route");
...
const moduleRoutes = [
    ...
    },
    {
        ...
        route: academicFaculty_route_2.AcademicDepartmentRouter,
    },
    {
    ...
    {
        path: '/facultys',
        route: faculty_routes_1.FacultyRoute,
    },
    {
        path: '/admins',
