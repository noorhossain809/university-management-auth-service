...
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield faculty_model_1.Faculty.findById(id);
    if (!isExist) {
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Faculty not found !');
    }
    ...
    const result = yield faculty_model_1.Faculty.findByIdAndUpdate(id, updatedFacultyData, {
        new: true,
    });
    return result;
});
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!faculty) {
            throw new ApiError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, 'Failed to delete student');
        }
        // delete user
